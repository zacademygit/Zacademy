    ...
    <>
      ...
      <section className="px-8 py-16 bg-white">
        <div className="max-w-2xl mx-auto text-center">
          <h3 className="text-2xl text-primary mb-3">გამოიწერეთ ჩვენი სიახლეები</h3>
          <p className="text-gray-700 mb-6">იყავით განახლებული ჩვენი უახლესი სიახლეებითა და ექსკლუზიური შეთავაზებებით</p>
