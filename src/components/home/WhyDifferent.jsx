...
const differences = [
    {
        ...
        title: '1-1 სესიები',
        description: 'არანაირი ჩაწერილი ვიდეოები, მხოლოდ ერთი-ერთზე კავშირი მენტორთან.'
    },
    {
        icon: (
            <svg className="text-white" width="28" height="28" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        title: 'კარიერული "ტესტ-დრაივი"',
        description: 'სანამ პროფესიის არჩევას გადაწყვეტ, დარწმუნდი რამდენად მოგწონს ის.'
    },
    {
        icon: (
            <svg className="text-white" width="28" height="28" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        title: 'ნეთვორქინგი',
        description: 'გაიცანი პროფესიონალები ტოპ კომპანიებიდან. პირადი კონტაქტები კარიერულ სამყაროში ძალიან ღირებულია.'
    },
    {
        icon: (
            <svg className="text-white" width="28" height="28" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        title: 'გამოცდილი მენტორები',
        description: 'ისწავლე პრაქტიკოსებისგან და არა თეორეტიკოსებისგან.'
    },
    {
        icon: (
            <svg className="text-white" width="28" height="28" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        title: 'შიდა სამზარეულო',
        description: 'გაიგე სიმართლე შიდა სამუშაო გარემოზე, ხელფასებსა და რეალურ მოთხოვნებზე'
    },
    {
        icon: (
            <svg className="text-white" width="28" height="28" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        title: 'დროის დაზოგვა',
        description: 'ინტერნეტში უსასრულო ძიების ნაცვლად, მიიღე პასუხები, რომლებიც რეალობას ზუსტად შეესაბამება.'
    }
];
